...
print("variable_a is a ", type(variable_a), "data type.")
print("variable_b is a ", type(variable_b), "data type.")
print("variable_c is a ", type(variable_c), "data type.")
print("variable_d is a ", type(variable_d), "data type.")
